...
* Saved microphone selection between launches
...
6. Use the live volume meter to help tune input levels.
7. Speak into the selected microphone.
...
* Microphone and sensitivity settings are automatically saved.
